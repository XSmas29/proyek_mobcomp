...
public class cProduct implements Parcelable{
    protected int id, fk_kategori, harga, stok;
    protected String fk_seller, nama, deskripsi, gambar;

    public cProduct(int id, String fk_seller, int fk_kategori, String nama, String deskripsi, int harga, int stok, String gambar) {
        this.id = id;
    ...
    public void writeToParcel(Parcel dest, int flags) {
        dest.writeInt(id);
        dest.writeInt(fk_kategori);
        dest.writeInt(harga);
        dest.writeInt(stok);
        dest.writeString(fk_seller);
